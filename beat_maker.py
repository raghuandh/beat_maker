...
Floor = mixer.Sound('sounds\\tom.WAV')
...
def draw_save_menu(beat_name, typing):
    ...
    screen.blit(saving_txt,(width//2-60, height*0.75+30))
    ...
    screen.blit(entry_text,(630,250))
...
def draw_load_menu(index):
    ...
    screen.blit(loading_txt,(width//2-60, height* .87+30))
    ...
    load_btn = pygame.draw.rect(screen, gray, [width-200,height-100,180,90],0,5)
    load_text = label_font.render('Close',True,white)
    screen.blit(load_text, (width-160,height-70))
    laoded_rectangle=pygame.draw.rect(screen,gray,[190,90,1000,600],5,5)
    ...
    return load_btn,loading_btn, delete_btn, laoded_rectangle,loaded_info
...
while run:
    ...
    # lower Menu Buttons
    play_pause = pygame.draw.rect(screen, gray, [50,\
        height-150,200,100],0,5)
